...
public class SepiaToneStage extends Stage {
	private DrawingModel model;
	private Slider radiusSlider;
	private MainView view;

	public SepiaToneStage(DrawingModel drawingModel, MainView mainView) {
		super();
		...
		if (this.model.getImageView() != null) {
			this.model.getImageView().setEffect(sepiaTone);
		}
		this.model.getCanvas().getGraphicsContext2D().setEffect(sepiaTone);
		...
		applyButton.setOnAction(e -> {
			...
			this.model.getCanvas().getGraphicsContext2D().applyEffect(sepiaTone);
			if (this.model.getImageView() != null) {
				this.model.getImageView().setEffect(null);
			}
			this.close();
		...
		//
		this.radiusSlider = createEffectSlider(sepiaTone);
		//
	...
	public Slider createEffectSlider(SepiaTone sepiaTone) {
